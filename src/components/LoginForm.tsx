    ...
    <div className="min-h-screen bg-gradient-to-br from-app-blue-50 via-white to-app-green-50 flex items-center justify-center p-6">
      <div className="bg-white rounded-3xl p-8 w-full max-w-md shadow-xl border border-app-gray-200">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-app-gray-900">Bem-vindo de volta!</h2>
          <p className="text-app-gray-600 mt-2">Entre na sua conta para continuar</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="text-center">
            <button
              type="button"
              className="text-sm text-app-gray-600 hover:text-app-blue-600"
            >
              Esqueceu a senha?
            </button>
          </div>
          ...
          <Button
            type="submit"
            className="w-full py-6 text-lg font-semibold bg-app-blue-600 hover:bg-app-blue-700 text-white rounded-lg"
          >
            Entrar
          </Button>
